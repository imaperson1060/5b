...
function resetLevel()
{
    ...
    for (var _loc1 = 0; _loc1 < charCount; ++_loc1)
    {
		...
		charCount2 = charsToFinish[currentLevel];
        /*if (_loc2 <= 5)
        {
            ++charCount2;
        } // end if*/
...
function drawMenu()
{
	...
	menuMovieClip.author.text = "By " + author;
	menuMovieClip.tip.text = getTip();
    var started = true;
	
	if (bfdia5b.data.mute)
	{
		musicSound.setVolume(0);

		menuMovieClip.menuSettings.page1.muteNo._x = menuMovieClip.menuSettings.page1.muteNo._x + 200;
		menuMovieClip.menuSettings.page1.muteYes._x = menuMovieClip.menuSettings.page1.muteYes._x - 200;
	}
	else
	{
	...
	if (bfdia5b.data.fullscreen == false)
	{
		menuMovieClip.menuSettings.page1.fullNo._x = menuMovieClip.menuSettings.page1.fullNo._x + 200;
		menuMovieClip.menuSettings.page1.fullYes._x = menuMovieClip.menuSettings.page1.fullYes._x - 200;
	}
	
	if (bfdia5b.data.hq == false)
	{
		setProperty("", _quality, "LOW");
		menuMovieClip.menuSettings.page2.qualityYes._x = menuMovieClip.menuSettings.page2.qualityYes._x - 200;
		menuMovieClip.menuSettings.page2.qualityNo._x = menuMovieClip.menuSettings.page2.qualityNo._x + 200;
	}
	
	if (bfdia5b.data.igtimer)
	{
		menuMovieClip.menuSettings.page2.timerYes._x = menuMovieClip.menuSettings.page2.timerYes._x + 200;
		menuMovieClip.menuSettings.page2.timerNo._x = menuMovieClip.menuSettings.page2.timerNo._x - 200;
	}
    ...
    menuMovieClip.menuNewGame.onRelease = function ()
    {
        if (started)
        {
            menuMovieClip.menuWatch._x = menuMovieClip.menuWatch._x + 1000;
            menuMovieClip.menuNewGame._x = menuMovieClip.menuNewGame._x + 1000;
            menuMovieClip.menuContGame._x = menuMovieClip.menuContGame._x + 1000;
            menuMovieClip.menuDiscord._x = menuMovieClip.menuDiscord._x + 1000;
            menuMovieClip.menuWebsite._x = menuMovieClip.menuWebsite._x + 1000;
            menuMovieClip.menuCredits._x = menuMovieClip.menuCredits._x + 1000;
			menuMovieClip.menuMore._x = menuMovieClip.menuMore._x + 1000;
    ...
    menuMovieClip.menuDiscord.onRelease = function ()
    {
		getURL("https://discord.gg/qtePFSH", "_blank");
    };
    menuMovieClip.menuWebsite.onRelease = function ()
    {
		getURL("https://5blevels.com", "_blank");
    };
	menuMovieClip.menuMore.onRelease = function ()
	{
		menuMovieClip.menuWatch._x = menuMovieClip.menuWatch._x + 1500;
		menuMovieClip.menuNewGame._x = menuMovieClip.menuNewGame._x + 1500;
		menuMovieClip.menuContGame._x = menuMovieClip.menuContGame._x + 1500;
		menuMovieClip.menuDiscord._x = menuMovieClip.menuDiscord._x + 1500;
		menuMovieClip.menuWebsite._x = menuMovieClip.menuWebsite._x + 1500;
		menuMovieClip.menuMore._x = menuMovieClip.menuMore._x + 1500;
		
		menuMovieClip.menuLevelCreator._x = menuMovieClip.menuLevelCreator._x - 1500;
		menuMovieClip.menuLevelCreatorGray._x = menuMovieClip.menuLevelCreatorGray._x - 1500;
		menuMovieClip.menuLevelViewer._x = menuMovieClip.menuLevelViewer._x - 1500;
		menuMovieClip.menuLevelViewerGray._x = menuMovieClip.menuLevelViewerGray._x - 1500;
		menuMovieClip.menuCredits._x = menuMovieClip.menuCredits._x - 1500;
		menuMovieClip.menuLess._x = menuMovieClip.menuLess._x - 1500;
	};
	menuMovieClip.menuLess.onRelease = function ()
	{
		menuMovieClip.menuWatch._x = menuMovieClip.menuWatch._x - 1500;
		menuMovieClip.menuNewGame._x = menuMovieClip.menuNewGame._x - 1500;
		menuMovieClip.menuContGame._x = menuMovieClip.menuContGame._x - 1500;
    ...
    menuMovieClip.menuCredits.onRelease = function ()
    {
		menuMovieClip.credits._x = menuMovieClip.credits._x - 1000;
		menuMovieClip.menuCredits._x = menuMovieClip.menuCredits._x + 500;
    };
	menuMovieClip.credits.back.onRelease = function ()
	{
		menuMovieClip.credits._x = menuMovieClip.credits._x + 1000;
		menuMovieClip.menuCredits._x = menuMovieClip.menuCredits._x - 500;
	};
	menuMovieClip.settingsButton.onRelease = function ()
	{
		if (menuMovieClip.menuSettings._x < 0)
		{
			menuMovieClip.menuSettings._x = menuMovieClip.menuSettings._x + 250;
			
			menuMovieClip.menuSettings.page1._visible = true;
			menuMovieClip.menuSettings.page2._visible = false;
		}
		else
		{
			menuMovieClip.menuSettings._x = menuMovieClip.menuSettings._x - 250;
	...
	menuMovieClip.menuSettings.quit.onRelease = function ()
	{
		close5b();
	};
	menuMovieClip.menuSettings.page1.fullYes.onRelease = function ()
	{
		fscommand("fullscreen", false);
		bfdia5b.data.fullscreen = false;
		bfdia5b.flush();

		menuMovieClip.menuSettings.page1.fullYes._x = menuMovieClip.menuSettings.page1.fullYes._x - 200;
		menuMovieClip.menuSettings.page1.fullNo._x = menuMovieClip.menuSettings.page1.fullNo._x + 200;
	};
	menuMovieClip.menuSettings.page1.fullNo.onRelease = function ()
	{
		fscommand("fullscreen", true);
		bfdia5b.data.fullscreen = true;
		bfdia5b.flush();

		menuMovieClip.menuSettings.page1.fullYes._x = menuMovieClip.menuSettings.page1.fullYes._x + 200;
		menuMovieClip.menuSettings.page1.fullNo._x = menuMovieClip.menuSettings.page1.fullNo._x - 200;
	};
	menuMovieClip.menuSettings.page1.muteYes.onRelease = function ()
	{
		musicSound.setVolume(0);
		bfdia5b.data.mute = true;
		bfdia5b.flush();

		menuMovieClip.menuSettings.page1.muteYes._x = menuMovieClip.menuSettings.page1.muteYes._x - 200;
		menuMovieClip.menuSettings.page1.muteNo._x = menuMovieClip.menuSettings.page1.muteNo._x + 200;
	};
	menuMovieClip.menuSettings.page1.muteNo.onRelease = function ()
	{
		musicSound.setVolume(100);
		bfdia5b.data.mute = false;
		bfdia5b.flush();

		menuMovieClip.menuSettings.page1.muteYes._x = menuMovieClip.menuSettings.page1.muteYes._x + 200;
		menuMovieClip.menuSettings.page1.muteNo._x = menuMovieClip.menuSettings.page1.muteNo._x - 200;
	};
	menuMovieClip.menuSettings.page2.timerYes.onRelease = function ()
	{
		bfdia5b.data.igtimer = false;
		bfdia5b.flush();
		
		menuMovieClip.menuSettings.page2.timerYes._x = menuMovieClip.menuSettings.page2.timerYes._x - 200;
		menuMovieClip.menuSettings.page2.timerNo._x = menuMovieClip.menuSettings.page2.timerNo._x + 200;
	};
	menuMovieClip.menuSettings.page2.timerNo.onRelease = function ()
	{
		bfdia5b.data.igtimer = true;
		bfdia5b.flush();
		
		menuMovieClip.menuSettings.page2.timerYes._x = menuMovieClip.menuSettings.page2.timerYes._x + 200;
		menuMovieClip.menuSettings.page2.timerNo._x = menuMovieClip.menuSettings.page2.timerNo._x - 200;
	};
	menuMovieClip.menuSettings.page2.qualityYes.onRelease = function ()
	{
		setProperty("", _quality, "LOW");
		bfdia5b.data.hq = false;
		bfdia5b.flush();
		
		menuMovieClip.menuSettings.page2.qualityYes._x = menuMovieClip.menuSettings.page2.qualityYes._x - 200;
		menuMovieClip.menuSettings.page2.qualityNo._x = menuMovieClip.menuSettings.page2.qualityNo._x + 200;
	};
	menuMovieClip.menuSettings.page2.qualityNo.onRelease = function ()
	{
		setProperty("", _quality, "HIGH");
		bfdia5b.data.hq = true;
		bfdia5b.flush();
		
		menuMovieClip.menuSettings.page2.qualityYes._x = menuMovieClip.menuSettings.page2.qualityYes._x + 200;
		menuMovieClip.menuSettings.page2.qualityNo._x = menuMovieClip.menuSettings.page2.qualityNo._x - 200;
	};
	menuMovieClip.menuSettings.page1.page2.onRelease = function ()
	{		
		menuMovieClip.menuSettings.page1._visible = false;
		menuMovieClip.menuSettings.page2._visible = true;
	};
	menuMovieClip.menuSettings.page2.page1.onRelease = function ()
	{
		menuMovieClip.menuSettings.page1._visible = true;
		menuMovieClip.menuSettings.page2._visible = false;
	};
...
function drawLevelMap()
{
    ...
    for (var _loc3 = 0; _loc3 < levelCount; ++_loc3)
    {
        var _loc4 = _loc3;
        if (_loc4 >= 100)
        {
...
function playLevel(i)
{
	...
	if (!bfdia5b.data.igtimer)
	{
		...
		levelButtons.levelTimerText._visible = false;
		levelButtons.levelBestTimeText._visible = false;
		levelButtons.levelTotalTimeText._visible = false;
	}
...
{	
	if (wipeTimer != 30) levelTimer2 += 16.666;
	levelButtons.levelTimer.text = toHMS(levelTimer2);
	
	if (!bfdia5b.data.best[currentLevel]) {
		levelButtons.levelBestTime.text = toHMS(levelTimer2);
	}
	
	levelButtons.levelTotalTime.text = toHMS(timer + levelTimer2);
    ...
    if (menuScreen == 3 || menuScreen == 4)
    {
        if (wipeTimer == 30)
        {
            ...
            else if (menuScreen == 4 && charsAtEnd >= charCount2)
            {
				...
				if ((!bfdia5b.data.best[currentLevel]) || (bfdia5b.data.best[currentLevel] > levelTimer2)) {
					best[currentLevel] = levelTimer2;
				}
        ...
        if (cutScene == 1 || cutScene == 2)
        {
			...
			else if (Key.isDown(16))
			{
				if (!csPress && cutScene == 1)
                {
	                ...
	                else if (!dialogueRequired[currentLevel])
					{
	                	endCutScene();
...
function getTip()
{
	if (!bfdia5b.data.firstLaunch) {
		bfdia5b.data.firstLaunch = true;
		bfdia5b.flsuh();
		return "This section is for tips. You will only see this message the first time you start 5b.";
	}
	...
	while (recursion <= 250)
	{
		...
		if (Math.floor(Math.random() * tip.rarity) + 1 == tip.rarity) {
			return tip.message;
		}
		else
		{
